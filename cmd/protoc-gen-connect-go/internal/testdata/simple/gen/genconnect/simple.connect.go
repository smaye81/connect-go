...
type TestServiceClient interface {
	...
	MethodClientStream(context.Context) *connect.ClientStreamForClientSimple[gen.Request, gen.Response]
...
func (c *testServiceClient) MethodClientStream(ctx context.Context) *connect.ClientStreamForClientSimple[gen.Request, gen.Response] {
